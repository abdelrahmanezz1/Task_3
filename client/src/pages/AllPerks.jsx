...
export default function AllPerks() {
  ...
  // --- Effect #1: Load all perks initially and on filter change ---
  useEffect(() => {
    loadAllPerks()
  }, [searchQuery, merchantFilter]) // re-fetch automatically when search/filter changes

  // --- Effect #2: Update unique merchant list whenever perks change ---
  useEffect(() => {
